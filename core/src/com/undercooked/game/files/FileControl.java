...
public class FileControl {
    ...
    public static String getDataPath(String endsWith) {
        if (System.getProperty("os.name").equals("Linux")) {
            ...
            // ? Change the above to:
            // System.getenv("APPDATA") + "/PiazzaPanic/data/" + Constants.DATA_FILE +
            // endsWith;
        }
        return "/data/" + Constants.DATA_FILE + endsWith;
    }
    ...
    /**
     * Saves a {@link String} to a file. Creates the files and directory if
     * they don't exist.
     *
     ...
     * @return {@link String} : The file's data, or {@code null} if it couldn't
     *         load.
     */
    public static String loadFile(String dir, String fileName, boolean internal) {
        ...
        if (!directory.isDirectory() && !internal && !directory.file().mkdirs()) {
     ...
     * @param fileName {@link String} : The name of the file to load from.
     * @param internal {@code boolean} : Whether the file is internal or external.
     * @return {@link JsonValue} : The file's data, or {@code null} if it couldn't
     *         load.
     */
