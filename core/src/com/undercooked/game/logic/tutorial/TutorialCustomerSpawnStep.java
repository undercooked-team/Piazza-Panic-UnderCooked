...
public class TutorialCustomerSpawnStep extends TutorialFollowEntityStep {
  ...
  /**
   * Constructor for the {@link TutorialCustomerSpawnStep}.
   *
   * @param text               {@link String} : The text to display
   * @param textSpeed          {@link float} : The number of characters to add per second.
   * @param customerController {@link CustomerController} : The {@link CustomerController}
   *                                                        to spawn using.
   * @param request            {@link Request} : The {@link Request} of the {@link Customer}.
   */
  public TutorialCustomerSpawnStep(String text, float textSpeed,
                                   CustomerController customerController, Request request) {
  ...
  public void update(float delta) {
    if (spawnedCustomer != null) {
      posX = spawnedCustomer.getX();
      posY = spawnedCustomer.getY();
    }
    super.update(delta);
  }
