...
public class TutorialStep {
  ...
  /**
   * Whether inputs for the {@link com.undercooked.game.entity.cook.Cook}s should
   * be processed for this step or not.
   */
  ...
  /**
   * Returns the x position that the camera should be focused at.
   *
  ...
  /**
   * Returns the y position that the camera should be focused at.
   *
  ...
  /**
   * Returns the text currently to be displayed.
   *
  ...
  /**
   * Returns if the player can move around with the {@link com.undercooked.game.entity.cook.Cook}
   * while this step is active or not.
   *
  ...
  /**
   * Returns if the step can be skipped by pressing Enter or not.
   *
  ...
  /**
   * Returns if the step has text to be displayed or not.
   *
