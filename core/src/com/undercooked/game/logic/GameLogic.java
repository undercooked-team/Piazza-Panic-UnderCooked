...
public abstract class GameLogic {
  ...
  public void win() {
    ...
    WinScreen winScreen = (WinScreen) (
            gameScreen.getScreenController().getScreen(Constants.WIN_SCREEN_ID)
    );
    // Go to win screen
    ...
    winScreen.setLeaderboardName(
            leaderboardName + " - "
            + StringUtil.convertToTitleCase(Difficulty.toString(difficulty)));
  }
  ...
  public final void loadMap(String path) {
    map = gameScreen.getMapManager().load(path, stationController,
                                          cookController, interactions,
                                          items);
  ...
  /**
   * Sets the {@link #leaderboardId}, the id of the
   * {@link com.undercooked.game.util.leaderboard.Leaderboard}
  ...
  /**
   * Returns the {@link Map} that the game is using.
   *
  ...
  /**
   * Returns the {@link CustomerController} instance of the game.
   *
  ...
  /**
   * Returns the {@link CookController} instance of the game.
   *
  ...
  /**
   * Returns the {@link Customer} that should have their {@link Request} displayed.
   *
  ...
  /**
   * Returns the {@link Items} instance of the game, that contains
   * all of the {@link com.undercooked.game.food.Item} instances
   * for all the item ids.
   *
  ...
  /**
   * Returns the player's score as a {@link String}.
   *
  ...
  /**
   * Returns how much reputation the player has remaining.
   *
  ...
  /**
   * Returns the quantity of money the player has, where the number
   * is in the number of pennies.
   *
  ...
  public void deserialise(JsonValue gameRoot) {
    ...
    // Loads the stations
    stationController.deserializeStations(this, gameRoot.get("stations"),
                                          audioManager, interactions, items, map);
