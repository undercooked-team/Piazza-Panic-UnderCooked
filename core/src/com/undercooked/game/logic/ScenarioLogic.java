...
public class ScenarioLogic extends ScenarioLoadLogic {
  ...
  /**
   * Whether requests in the {@link #requestPool} can be added to the
   * {@link #requests} array more than once.
   */
  ...
  // Power Up variables
  /**
   * The multiplier for the speed of the
   * {@link com.undercooked.game.interactions.Interactions}.
   */
   ...
   *
   * @param game           {@link GameScreen} : The {@link GameScreen} using the
   *                       {@link ScenarioLogic}.
  ...
  public ScenarioLogic(GameScreen game, TextureManager textureManager, AudioManager audioManager) {
    ...
    cookController.setServeListener(new Listener<Cook>() {
      ...
      public void tell(Cook cook) {
        ...
        // If all of that is valid, then send the item and cell to the
        // CustomerController
  ...
  /**
   * Spawns more {@link PowerUp}s, updates all of the {@link PowerUp}s in the
   * game,
  ...
  /**
   * Creates a new {@link PowerUp} in a random, open {@link MapCell} that doesn't
   * have
   ...
   *                    effect of.
   * @param powerUp     {@link PowerUp} : The {@link PowerUp} providing the
   *                    effect.
   */
   ...
   *
   * @param powerUpType {@link PowerUpType} : The {@link PowerUpType} to remove
   *                    the
   *                    effect of.
   */
   ...
   * Removes a {@link PowerUp}'s effect.
   *
   * @param powerUp {@link PowerUp} : The {@link PowerUp} that provided the
   *                effect.
   */
   ...
   * from being rendered.
   * <br>
   * In addition, if another power up of the same type is already
  ...
  /**
   * Removes a {@link PowerUp} {@link com.undercooked.game.entity.Entity} from the
   * game.
   *
   * @param powerUp      {@link PowerUp} : The {@link PowerUp} to remove.
   * @param removeEffect {@code boolean} : Whether the effect of the
   *                     {@link PowerUp}
