...
public final class Constants {
  ...
  /**
   * The maximum length of a name input for a
   * {@link com.undercooked.game.util.leaderboard.LeaderboardEntry}.
   */
  ...
  /**
   * The register id, used for finding where
   * {@link com.undercooked.game.entity.customer.Customer}s need to wait.
   */
  public static final String REGISTER_ID = "<main>:register";
  /**
   * The phone id, used for the cell where the player gets more
   * {@link com.undercooked.game.entity.cook.Cook}s.
   */
  public static final String PHONE_ID = "<main>:phone";
  /**
   * The asset path for the custom scenario, which the player can select
  ...
  // Textures
  /**
   * The number of {@link com.undercooked.game.entity.cook.Cook}
   * {@link com.badlogic.gdx.graphics.Texture}s in the asset folder.
   */
  public static final int NUM_COOK_TEXTURES = 3;
  /**
   * The number of {@link com.undercooked.game.entity.customer.Customer}
   * {@link com.badlogic.gdx.graphics.Texture}s in the asset folder.
   */
