...
public class Station extends MapEntity {
  ...
  public InteractResult interact(Cook cook, String inputId, InputType inputType) {
    ...
    return interactControl.interact(cook, inputId, inputType);
  }
  ...
  /**
   * Returns the price of the {@link Station}.
   *
  ...
  /**
   * Returns whether the {@link Station} is disabled or not.
   *
  ...
  /**
   * Returns whether the {@link Station} has any {@link Cook}s locked.
   *
  ...
  /**
   * Returns whether the {@link Station} has a specific {@link Cook} locked
   * or not.
   *
