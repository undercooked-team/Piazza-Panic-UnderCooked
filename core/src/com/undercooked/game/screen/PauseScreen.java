...
public class PauseScreen extends Screen {
  ...
  public void postLoad() {
    ...
    // Create the Buttons
    Button unpause = new Button(new TextureRegionDrawable(
            textureManager.get("uielements/game/resume.png")
    ));
    Button menu = new Button(new TextureRegionDrawable(
            textureManager.get("uielements/game/exit.png")
    ));
    ...
    if (saveEnabled) {
      // Make the button
      Button save = new Button(new TextureRegionDrawable(
              textureManager.get("uielements/game/save.png")
      ));
    ...
    audioSliders = game.getAudioSettings().createAudioSliders(320, 100, stage,
            textureManager.get("uielements/background.png"),
            textureManager.get("uielements/vButton.jpg")
    );
  ...
  public void quitToMenu() {
    ...
    if (!getScreenController().onScreen(Constants.PAUSE_SCREEN_ID)) {
      return;
    }
  ...
  /**
   * Sets whether the save button to save the game is visible and can be
   * pressed or not.
   *
