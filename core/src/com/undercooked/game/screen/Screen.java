...
public abstract class Screen implements com.badlogic.gdx.Screen {
  ...
  /**
   * Returns the number of times the {@link Screen} has been loaded.
   *
  ...
  /**
   * Returns whether the {@link Screen} is loaded or not.
   *
  ...
  /**
   * Returns the {@link TextureManager} of the game.
   *
  ...
  /**
   * Returns the {@link ScreenController} of the game.
   *
  ...
  /**
   * Returns the {@link MapManager} of the game.
   *
