...
public class AudioSettings {
   ...
   */
  public AudioSliders createAudioSliders(float x, float y, Stage stage,
                                         Texture backText, Texture buttonTex) {
  ...
  /**
   * Returns the volume of the music in the game.
   *
  ...
  /**
   * Returns the volume of the game sounds within the game.
   *
