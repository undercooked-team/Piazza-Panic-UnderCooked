...
public class InteractionInstance {
  ...
  /**
   * Constructor for the {@link InteractionInstance}.
   *
   * @param station         {@link Station} : The {@link Station} that holds this
   *                        interaction instance.
   * @param interactControl {@link StationInteractControl} : The {@link StationInteractControl}
   *                        that controls the interaction data.
   * @param audioManager    {@link AudioManager} : The {@link AudioManager} to use.
   * @param gameItems       {@link Items} : The {@link Items} of the game.
   */
  public InteractionInstance(Station station, StationInteractControl interactControl,
                             AudioManager audioManager, Items gameItems) {
  ...
  /**
   * Returns the last check that was done for the change in time since
   * the last frame.
   *
